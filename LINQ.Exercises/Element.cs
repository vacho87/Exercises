...
namespace LINQ.Exercises
{
    ...
    {        
        ...
        {
            int result = TestData.Numbers.FirstOrDefault(n => n > 10);  // Заменил метод First на метод FirstOrDefault (или нужно было иначе?)           
        ...
        {
            string result = TestData.Animals.Last(str => str == "elephant");
        ...
        {
            string result = TestData.Animals.First(str => str.Length == 4);
        ...
        {
            string result = TestData.Animals.Last(str => str.Contains('g'));
        ...
        {
            string result = TestData.Animals.First(str => str.ElementAt(0) == 's');
