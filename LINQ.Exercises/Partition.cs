...
namespace LINQ.Exercises
{
    ...
    public class Partition
    {
        ...
        {
            IEnumerable<int> result = TestData.PartitionNumbers.TakeWhile(number => number <= 6);
        ...
        {
            IEnumerable<int> result = TestData.PartitionNumbers.SkipWhile(number => number % 3 != 0);
